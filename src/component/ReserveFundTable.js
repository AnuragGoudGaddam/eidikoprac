...
import { ReserveFundColumns } from "../app-data/ReserveFundColumns";
export const ReserveFundTable = (props) => {
  const columns = useMemo(() => ReserveFundColumns, []);
  ...
  return (
    <>
      <div style={{ marginLeft: "83%", width: "18%", marginTop: "-1rem" }}>
